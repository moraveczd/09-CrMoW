...
\frame{
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			...
			\textbf{Seaborgium}
			\begin{itemize}
				\item Umělý prvek, transuran, protonové číslo 106, Sg.
				\item Poprvé byl připraven v roce 1971:
				\item \ce{^{208}_{82}Pb + ^{54}_{24}Cr -> ^{260}_{106}Sg + 2 n}
				\item \ce{^{207}_{82}Pb + ^{54}_{24}Cr -> ^{260}_{106}Sg + n}
				\item Bylo pojmenován po americkém chemikovi Glennu T. Seaborgovi, který získal Nobelovu cenu za objev plutonia.\footnote[frame]{\href{https://www.nobelprize.org/prizes/chemistry/1951/seaborg/facts/}{Glenn T. Seaborg}}
		...
		\begin{column}{.35\textwidth}
			\begin{figure}
				\adjincludegraphics[width=.6\textwidth]{img/Glenn_Seaborg.jpg}
				\caption*{Glenn Seaborg.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:Glenn_Seaborg_-_1964.jpg}{Atomic Energy Commission/Commons}}}
			\end{figure}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Amesite,_uvarovite_1100FS.2015.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.3\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Uvarov_the_elder.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{itemize}
		...
		\item Většina vyrobeného ferrochromu se využívá pro výrobu nerezové oceli, která obsahuje přibližně 18~\% chromu.
	\end{itemize}
	\begin{figure}
	\adjincludegraphics[height=.4\textheight]{img/Ferrochrome.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Molybdenite.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Molybdenite_quebec2.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.75\textheight]{img/Kristallradio.jpg}
		\caption*{Hrotová dioda z rádia užívaná před 2. světovou válkou}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Calcite-Wulfenite-tcw15a.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Maroc_Wulfénite.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Powellite-23107.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Powellite-k336b.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{MoO3 + 2 NH3 + H2O -> (NH4)2(MoO4)}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
	\adjincludegraphics[height=.4\textheight]{img/Arc_W.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Fluorite-Scheelite-cflo37a.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Výchozí surovinou pro kovový wolfram je hydratovaný oxid wolframový, který se označuje jako \textit{wolframová kyselina}.
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/Motorcycle_Reflections.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/ChamberWindow.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/Corundum-215330.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{2 NO2 + Mo ->[320 $^\circ$C] NO + MoO3}
...
\frame{
	...
	\begin{column}{.5\textwidth}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/Quadro40.jpg}
	\end{figure}
	\end{column}
		\begin{column}{.5\textwidth}
		\begin{figure}
			\adjincludegraphics[height=.4\textheight]{img/Inserti_widia.jpg}
		\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{figure}
		\adjincludegraphics[height=.7\textheight]{img/APFSDS-T-01.jpg}
	\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.55\textheight]{img/Electric_bulb_filament.jpg}
	\end{figure}
	\vfill
}
	...
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			\begin{center}
				...
				Krystalová struktura \ce{KC8}, fialové kuličky představují ionty \ce{K+}
			\end{center}
		\end{column}
	\end{columns}
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.8\textheight]{img/Ar2Cr2PP.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.8\textheight]{img/Quintuple_bond_MO_diagram.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.8\textheight]{img/Quintuple_bond_orbital_diagram2.png}
	\end{figure}
	\vfill
}
	...
	\begin{columns}
		\begin{column}{0.7\textwidth}
			...
			\begin{itemize}
				...
				\item \ce{2 CrCl2 + 4 CH3COONa + 2 H2O -> Cr2(CH3COO)4(H2O)2}
			\end{itemize}
			\vfill
		\end{column}
		\begin{column}{0.35\textwidth}
			...
			\end{figure}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/Chromium(II)-acetate-dimer-3D-balls.png}
			\end{figure}
		\end{column}
	\end{columns}
}
...
\frame{
	...
	\begin{align*}
		\ce{HCrO$^-_4$ &<=> CrO$^{2-}_4$ + H^+} \\
		\ce{H2CrO4 &<=> HCrO$^{-}_4$ + H^+} \\
		\ce{Cr2O7 + H2O &<=> 2 HCrO$^{-}_4$} \\
...
\frame{
	...
	\begin{figure}
		...
		\caption*{a) \ce{Mo6O$_{19}^{2-}$}; b) \ce{Mo7O$_{24}^{6-}$}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Struktura heteropolyaniontu \ce{[PW12O40]^{3-}}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=.85\textwidth]{img/Molybdenite-3D-balls.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Předčasně naklíčená kukuřice.\footnote[frame]{\href{https://commons.wikimedia.org/wiki/File:Premature_germination_maize_2014_05_15_10_35_37_7919.jpg}{Zdroj: Alandmanson/Commons}}}
	\end{figure}
	\vfill
}
